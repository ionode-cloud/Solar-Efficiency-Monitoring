...
const MONGO_URI = process.env.MONGO_URI || 'mongodb+srv://ionode:ionode@ionode.qgqbadm.mongodb.net/SolarMonitoring?retryWrites=true&w=majority&appName=ionode';
...
// --- 6. START SERVER ---
const port = process.env.PORT || 62889; // Using another new port to avoid conflicts
app.listen(port, () => {
